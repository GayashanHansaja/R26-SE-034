...
function OAuthButtons() {
  const handleOAuth = async (provider) => {
    try {
      ...
      const res = await apiClient.get(`/auth/oauth/${provider}/authorize`);
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 py-2.5 text-xs font-medium text-white/70 transition hover:bg-white/10"
      >
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 py-2.5 text-xs font-medium text-white/70 transition hover:bg-white/10"
      >
        <svg className="h-4 w-4 fill-white/70" viewBox="0 0 24 24">
